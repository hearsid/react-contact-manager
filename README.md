...
Universal Javascript sample application with React Router 4 and Express 5 (Enhanced version of https://github.com/hearsid/react-contact-manager)

## Setup

```bash
git clone git@github.com:hearsid/react-contact-manager.git
